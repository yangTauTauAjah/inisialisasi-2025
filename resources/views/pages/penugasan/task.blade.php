...
<body>
                ...
                <div class="site-navigation">
                    <div class="row g-0 justify-content-between align-items-center">
                        <div class="col-lg-3 col-8">
                            <a href="/" class="logo m-0 float-start text-dark">INISIALISASI 2024<span
                                    class="text-dark">.</span></a>
                        </div>
                        <div class="col-log-7 col-4 text-end ">
                            <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                                <li><a class="text-dark" href="index.html">Home</a></li>
                                <li><a class="text-dark" href="/penugasan">Penugasan Alim</a></li>
                                <li><a class="text-dark" href="/task">Penugasan Alif</a></li>
                            </ul>
                            <a href="#"
    ...
    <div class="section sec-portfolio bg-light pb-5" id="about" style="padding-top: 150px">
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-5 mx-auto text-center ">
                    <div class="d-flex gap-2 justify-content-center">
                        <h2 class="heading">PENUGASAN</h2>
                    </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body text-start">
                                    <ul>
                                        <li>Tugas 1 - ID CARD</li>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Exercitationem
                                            ipsam fugiat reprehenderit, laborum nihil ullam natus doloremque nesciunt
                                            impedit minus cum harum delectus commodi, officia dolorum! Magnam sed minus
                                            quia.</p>
                                            <div class="d-flex form-group">
                                                <input type="file" class="form-control" name="" id="">
                                                <input type="submit" class="btn btn-sm btn-success">
                                            </div>
                                        <li>Tugas 2 - Booklet</li>
                                        <li>Tugas 3 - Video</li>
                                    </ul>
                                </div>
                            </div>
