...
<body>
    ...
    <div class="container mt-4">
        <div data-v-373b54c8="" class="col-12 d-flex justify-content-between align-items-center gap-3 flex-wrap flex-sm-nowrap mb-0"><h2 data-v-373b54c8="" class="font-semibold text-limit limit-1 ">
            Nama dan Logo Angkatan
        </h2>
        </div>
        <div class="forum-card accordion card-body">
            <p>Mahasiswa baru D4 Teknik Informatika angkatan 2024 <span class="highlight">WAJIB</span> membuat nama dan logo angkatan dengan ketentuan:</p>
        <ul>
            <li>Nama angkatan memiliki makna dan dapat melambangkan angkatan sendiri.</li>
            <li>Desain logo angkatan dibuat sekreatif mungkin.</li>
