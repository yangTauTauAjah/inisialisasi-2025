    ...
    <div class="container mt-4">
        ...
        <div class="forum-card accordion card-body">
            <div class="campus-section">
                ...
                <p>24 kating yang dibagi menjadi 2 kloter.</p>
                <p><strong>Alur meminta biodata kating:</strong></p>
                <p>Info tentang kontak kakak tingkat dapat dilihat di: <a href="https://bit.ly/DatabaseKating1Inisialisasi" class="info-link">https://bit.ly/DatabaseKating1Inisialisasi</a></p>
                <ul>
                    ...
                    <li>Setelah mahasiswa baru melakukan feedback yang diminta oleh kakak tingkat, mahasiswa baru diperbolehkan untuk mengatur jadwal pertemuan dengan kakak tingkat tsb.</li>
                    <li>Mahasiswa baru diwajibkan untuk foto bersama masing-masing kakak tingkat tersebut sebagai bukti dari penugasan.</li>
                </ul>
                <p><strong>Point yang harus ada!</strong></p>
                <ul>
            ...
            <div class="campus-section">
                ...
                <ul>
                    ...
                    <li>Setelah mahasiswa baru melakukan feedback yang diminta oleh kakak tingkat, mahasiswa baru diperbolehkan untuk menscreenshot dengan kakak tingkat tsb.</li>
                </ul>
                <p><strong>Point yang harus ada!</strong></p>
                <ul>
                    <li>Nama lengkap Kakak Tingkat</li>
